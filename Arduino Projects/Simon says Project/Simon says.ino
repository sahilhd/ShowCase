...
#define NOTE_B0 31
#define NOTE_C1 33
#define NOTE_CS1 35   // a lot of notes to be made according to peizo
#define NOTE_D1 37
#define NOTE_DS1 39
#define NOTE_E1 41
#define NOTE_F1 44
...
boolean play_battle(void)
{
  ...
  while (1) // Loop until someone fails 
  {
    ...
    delay(1000); // Give the user an extra 100ms to hand the game to the other player
  }
...
/* piezo works by applying
a voltage to a piezoelectric material, it creates the 
initial mechanical motion. Furthermore, diaphragms
and resonators typically convert the motion into audible sound*/
